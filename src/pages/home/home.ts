...
export class HomePage {
  ...
  constructor(public nav: NavController, public dataService: DataProvider,
    public alertCtrl: AlertController, public storage: Storage, public platform: Platform, public keyboard: Keyboard) {
  }
  ...
  ionViewDidLoad() {
    ...
    this.platform.ready().then(() => {
      this.storage.get('introShown').then((result) => {
        ...
        resultaat = false;
        console.log(' storage get introshown');


        console.log(' storage get introshown result: ', result);
